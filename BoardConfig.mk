...
# Kernel
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom msm_rtb.filter=0x37 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 boot_cpus=0-3 androidboot.selinux=enforcing androidboot.verifiedbootstate=green androidboot.veritymode=enforcing androidboot.enable_dm_verity=1 androidboot.secboot=enabled buildvariant=user
